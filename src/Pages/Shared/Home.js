        ...
        <div>
            <div class="hero  bg-base-200">
                <div class="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        <h1 class="text-5xl font-bold text-success uppercase"> Sadia Tuz Johora!</h1>
                        <p class="py-6 uppercase text-primary">A junior web developer</p>
                        <div>
            ...
            <div class="hero min-h-screen bg-base-200">
                <div class="hero-content text-center">
                    <div class="max-w-md">
                        ...
                        <p class="py-6 text-primary">Thinking of starting a career in Web Development was not an easy decision.
